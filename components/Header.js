    ...
    <header className='sticky top-0 bg-white'>
      <div className='flex w-full p-6 items-center'>
        <Image
          ...
          onClick={() => router.push('/')}
        />
        <form className='flex flex-grow px-6 py-2 ml-10 mr-5 border border-gray-200 rounded-full shadow-lg max-w-2xl items-center'>
          <input
            type='text'
        ...
        <Avatar
          className='ml-auto'
          url='https://avatars.githubusercontent.com/u/36196171?s=60&v=4'
        />
      </div>
